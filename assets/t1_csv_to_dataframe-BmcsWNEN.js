...
line of the file for a series of data labels:`,code:`Customer ID, Vehicle Registration, Date of Birth`}),(0,i.jsx)(r,{content:`Now we can see that the first value in each line is that entry's Customer ID, 
...
To make a well formed CSV:`,code:`Customer ID, Vehicle Registration, Date of Birth
05898, AWR584, 6/12/1978
02785, BLH967, 4/5/2001`}),(0,i.jsx)(r,{content:`Here's an example .csv of an AAPL daily price record:`,code:`Date,Code,Open,High,Low,Close,Volume,Value,Trans,Adj,Exchange,DataSource
